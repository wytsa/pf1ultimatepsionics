...
Instructions
Download the ZIP file and delete "-main" from the folder name, place into Modules folder. Activate the module via the in game module browser within Foundry.
